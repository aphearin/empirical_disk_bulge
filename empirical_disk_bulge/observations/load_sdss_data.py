...
def load_umachine_sdss_complete(dirname='/Users/aphearin/work/sdss/cross_matched_catalogs/meert15',
    ...
    sdss['bt_mendel13'] = (10**sdss['logMB_mendel13'])/(10**sdss['logMB_mendel13']+10**sdss['logMD_mendel13'])
